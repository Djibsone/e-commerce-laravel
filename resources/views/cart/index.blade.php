    ...
    <div class="container">
                  ...
                  <th scope="row">
                    <div class="p-2">
                      ...
                      <div class="ml-3 d-inline-block align-middle">
                        <h5 class="mb-0">
                         <a href="#" class="text-dark d-inline-block">{{ $product->model->title }}</a></h5><span class="text-muted font-weight-normal font-italic">Category: Fashion</span>
                      </div>
                    </div>
                    ...
                    <td class="align-middle">
                      <strong>
                        <div class="col-sm-4">
                          <input type="number"name="qty" class="form-control" value="{{ $product->qty ? $product->qty : '' }}" min="1" id="qty" data-id="{{ $product->rowId }}">
                        </div>
                      </strong>
                    </td>
                    <td class="align-middle">
      ...
      <div class="row py-5 p-4 bg-white rounded shadow-sm">
        <div class="col-lg-6">
          ...
          <div class="p-4">
            <p class="font-italic mb-4">Si vous avez un code de coupon, veuillez le saisir dans la case ci-dessous</p>
          ...
          <div class="p-4">
            <p class="font-italic mb-4">Si vous avez des informations exclusives pour le vendeur, vous pouvez laisser dans la case ci-dessous</p>
            <textarea name="" cols="30" rows="2" class="form-control"></textarea>
          </div>
        </div>
        <div class="col-lg-6">
        <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Details Commande</div>
          <div class="p-4">
